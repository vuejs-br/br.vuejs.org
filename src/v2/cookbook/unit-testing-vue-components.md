...
```
O trecho de código acima mostra como testar se uma mensagem de erro deve aparecer com base no comprimento do nome de usuário. Ele demonstra a ideia geral dos componentes do Vue de teste de unidade: renderizar o componente e afirmar que o código corresponde ao estado do componente.

## Por que testar?

Testes de unidade em componentes têm muitos benefícios:
...
[Vue Test Utils](https://github.com/vuejs/vue-test-utils) é a biblioteca oficial para testar componentes Vue. O template `webpack` que pode ser criado via [vue-cli](https://github.com/vuejs/vue-cli) vem com Karma ou Jest, ambos executadores de teste bem suportados, e há alguns [guias](https://vue-test-utils.vuejs.org/guides/) na documentação do Vue Test Utils.
